...
class GameplaySettingsSubState extends BaseOptionsMenu
{
	public function new()
	{
		...
		'If checked, the game will send most if not ALL images to VRAM. At least 4 GB VRAM GPU reccomended.', // Description
		'gpuCache', // Save data variable name
		'bool', // Variable type
		false); // Default value

		var option:Option = new Option('Cam Angle Tilt', // Name
		'If checked, the game will angle the camera on a note hit.', // Description
		'camMoveTilt', // Save data variable name
		'bool', // Variable type
		true); // Default value
	addOption(option);
