...
class CharacterEditorState extends MusicBeatState
{
	...
	var cameraZoomText:FlxFixedText;
	var frameAdvanceText:FlxFixedText;
	...
	var anims = null;
	var animsTxtGroup:FlxTypedGroup<FlxFixedText>;
	var curAnim = 0;
	...
	override function create()
	{
		...
		animsTxtGroup = new FlxTypedGroup<FlxFixedText>();
		...
		healthBar = new FlxBar(30, FlxG.height - 75);
		...
		var tipText:FlxFixedText = new FlxFixedText(FlxG.width - 300, FlxG.height - 24, 300, "Press F1 for Help", 16);
		...
		cameraZoomText = new FlxFixedText(0, 50, 200, 'Zoom: 1x');
		...
		frameAdvanceText = new FlxFixedText(0, 75, 350, '');
	...
	function addHelpScreen()
	{
		...
		for (i in 0...arr.length)
		{
			...
			var helpText:FlxFixedText = new FlxFixedText(0, 0, 600, arr[i], 16);
	...
	function addGhostUI()
	{
		...
		#if !hl
		var ghostAlphaSlider:FlxUISlider = new FlxUISlider(this, 'ghostAlpha', 10.0, makeGhostButton.y + 25.0, 0.0, 1.0, 210, null, 5, FlxColor.WHITE, FlxColor.BLACK);
	...
	function addSettingsUI()
	{
		...
		tab_group.add(new FlxFixedText(charDropDown.x, charDropDown.y - 18, 0, 'Character:'));
	...
	var animationInputText:FlxUITextInput;
	var animationNameInputText:FlxUITextInput;
	var animationIndicesInputText:FlxUITextInput;
	...
	function addAnimationsUI()
	{
		...
		animationInputText = new FlxUITextInput(15, 85, 80, '', 8);
		animationNameInputText = new FlxUITextInput(animationInputText.x, animationInputText.y + 35, 150, '', 8);
		animationIndicesInputText = new FlxUITextInput(animationNameInputText.x, animationNameInputText.y + 40, 250, '', 8);
		...
		xmlAnims = character.getAnimationsFromXml();
		...
		tab_group.add(new FlxFixedText(animationDropDown.x, animationDropDown.y - 18, 0, 'Animations:'));
		tab_group.add(new FlxFixedText(animationInputText.x, animationInputText.y - 18, 0, 'Animation name:'));
		tab_group.add(new FlxFixedText(animationNameFramerate.x, animationNameFramerate.y - 18, 0, 'Framerate:'));
		tab_group.add(new FlxFixedText(animationNameInputText.x, animationNameInputText.y - 18, 0, 'Animation on .XML/.TXT file:'));
		tab_group.add(new FlxFixedText(animationIndicesInputText.x, animationIndicesInputText.y - 18, 0, 'ADVANCED - Animation Indices:'));
		tab_group.add(new FlxFixedText(xmlAnimDropDown.x, xmlAnimDropDown.y - 15, 0, 'Loaded Prefixes:'));
	...
	var imageInputText:FlxUITextInput;
	var healthIconInputText:FlxUITextInput;
	...
	function addCharacterUI()
	{
		...
		imageInputText = new FlxUITextInput(15, 30, 200, character.imageFile, 8);
		...
		healthIconInputText = new FlxUITextInput(15, imageInputText.y + 35, 75, healthIcon.getCharacter(), 8);
		...
		tab_group.add(new FlxFixedText(15, imageInputText.y - 18, 0, 'Image file name:'));
		tab_group.add(new FlxFixedText(15, healthIconInputText.y - 18, 0, 'Health icon name:'));
		tab_group.add(new FlxFixedText(15, singDurationStepper.y - 18, 0, 'Sing Animation length:'));
		tab_group.add(new FlxFixedText(15, scaleStepper.y - 18, 0, 'Scale:'));
		tab_group.add(new FlxFixedText(positionXStepper.x, positionXStepper.y - 18, 0, 'Character X/Y:'));
		tab_group.add(new FlxFixedText(positionCameraXStepper.x, positionCameraXStepper.y - 18, 0, 'Camera X/Y:'));
		tab_group.add(new FlxFixedText(healthColorStepperR.x, healthColorStepperR.y - 18, 0, 'Health bar R/G/B:'));
	...
	override function getEvent(id:String, sender:Dynamic, data:Dynamic, ?params:Array<Dynamic>) {
		if(id != FlxUITextInput.CHANGE_EVENT && id != FlxUINumericStepper.CHANGE_EVENT) return;

		if(sender is FlxUITextInput)
		{
	...
	override function update(elapsed:Float)
	{
		...
		if(changedOffset && anim != null && anim.offsets != null)
		{
			...
			var myText:FlxFixedText = animsTxtGroup.members[curAnim];
		...
		else if(FlxG.keys.justPressed.ESCAPE)
		{
			...
			else MusicBeatState.switchState(new states.game.PlayState());
			return;
		}
	}
	...
	inline function reloadAnimList()
	{
		...
		for (anim in anims)
		{
			var text:FlxFixedText = animsTxtGroup.recycle(FlxFixedText);
			text.x = 10;
			text.y = 32 + (20 * daLoop);
			text.fieldWidth = 400;
			text.fieldHeight = 20;
