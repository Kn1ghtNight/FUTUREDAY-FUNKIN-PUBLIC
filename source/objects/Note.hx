...
{
	public static var __pool:FlxTypedGroup<Note>; // pooling :)
	...
	function loadNoteAnims()
	{
		...
		if (isSustainNote)
		{
			animation.addByPrefix('purpleholdend', 'purple end hold'); // WHY WAS IT PRUPLE AND NOT PURPLE NINJA OYU BITCH
