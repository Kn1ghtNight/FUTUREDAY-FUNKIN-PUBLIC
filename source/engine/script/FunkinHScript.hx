...
class FunkinHScript extends FunkinScript
{
	...
	public function new(parsed:Expr, ?name:String = "Script", ?additionalVars:Map<String, Any>)
	{
        ...
        set("FunkCamera", engine.camera.FunkCamera);
		...
		});*/ // ill probably add scriptable states later, but not now!
...
class HScriptSubstate extends states.substates.MusicBeatSubstate
{
