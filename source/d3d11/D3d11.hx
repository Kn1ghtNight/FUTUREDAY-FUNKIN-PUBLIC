...
class D3d11
{
	 ...
	 * @return Int
	 */
	public static function createDevice(_adapter:Null<DxgiAdapter>, _driverType:D3dDriverType, _software:Null<cpp.Struct<HMODULE>>, _flags:Int,
			_featureLevels:Null<Array<D3dFeatureLevel>>, _sdkVersion:Int, _device:Null<D3d11Device>, _featureLevel:Null<Array<D3dFeatureLevel>>,
			_context:Null<D3d11DeviceContext>):D3d11Error
	{
		...
		var result = NativeD3D11.createDevice(adapterPtr, cast _driverType, _software, _flags, cast levelsPtr, levelsIdx, _sdkVersion, devicePtr,
			gotLevel.addressOf(), contextPtr);
...
extern class NativeD3D11
{
	...
	static function createDevice(_adapter:Star<NativeIDXGIAdapter>, _driverType:NativeD3DDriverType, _software:HMODULE, _flags:cpp.UInt32,
		_featureLevels:Star<NativeD3DFeatureLevel>, _featureLevelsCount:cpp.UInt32, _sdkVersion:cpp.UInt32, _device:Star<Star<NativeID3D11Device>>,
		_featureLevel:Star<NativeD3DFeatureLevel>, _immediateContext:Star<Star<NativeID3D11DeviceContext>>):Int;
