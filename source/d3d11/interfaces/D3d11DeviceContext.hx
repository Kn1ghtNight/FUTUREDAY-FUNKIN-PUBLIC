...
class D3d11DeviceContext extends Unknown
{
	 ...
	 */
	public function updateSubresource(_resource:D3d11Resource, _dstSubresource:Int, _box:Null<D3d11Box>, _srcData:BytesData, _srcRowPitch:Int,
			_srcDepthPitch:Int)
	{
		final buffer = (Pointer.arrayElem(_srcData, 0).reinterpret() : Pointer<cpp.Void>).ptr;

		(cast ptr : Star<NativeID3D11DeviceContext>).updateSubresource(cast _resource.ptr, _dstSubresource, if (_box == null) null else cast _box.backing,
			buffer, _srcRowPitch, _srcDepthPitch);
	}
	...
	public function omSetRenderTargets(_renderTargetViews:Null<Array<D3d11RenderTargetView>>, _depthStencilView:Null<D3d11DepthStencilView>)
	{
		if (_renderTargetViews != null)
		{
			...
			(cast ptr : Star<NativeID3D11DeviceContext>).omSetRenderTargets(_renderTargetViews.length, vectorRenderTargetView.data(),
				_depthStencilView == null ? null : cast _depthStencilView.ptr);
		}
		else
		{
			final nullptr:Star<NativeID3D11RenderTargetView> = null;

			(cast ptr : Star<NativeID3D11DeviceContext>).omSetRenderTargets(0, cpp.Native.addressOf(nullptr),
				_depthStencilView == null ? null : cast _depthStencilView.ptr);
		}
	}
	...
	public function omSetRenderTarget(_renderTargetView:Null<D3d11RenderTargetView>, _depthStencilView:Null<D3d11DepthStencilView>)
	{
		if (_renderTargetView != null)
		{
			...
			(cast ptr : Star<NativeID3D11DeviceContext>).omSetRenderTargets(1, vectorRenderTargetView.data(),
				_depthStencilView == null ? null : cast _depthStencilView.ptr);
		}
		else
		{
	...
	{
		(cast ptr : Star<NativeID3D11DeviceContext>).omSetBlendState(_blendState == null ? null : cast _blendState.ptr,
			_blendFactor == null ? null : cast Pointer.arrayElem(_blendFactor, 0).ptr, _sampleMask);
	}
	...
	public function iaSetVertexBuffers(_startSlot:Int, _buffers:Array<D3d11Buffer>, _strides:Array<Int>, _offsets:Array<Int>)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext>).iaSetVertexBuffers(_startSlot, _buffers.length, vectorBuffer.data(),
			cast Pointer.arrayElem(_strides, 0).ptr, cast Pointer.arrayElem(_offsets, 0).ptr);
	}
	...
	public function iaSetVertexBuffer(_slot:Int, _buffer:D3d11Buffer, _stride:Int, _offset:Int)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext>).iaSetVertexBuffers(_slot, 1, vectorBuffer.data(), cast VarPointer.addressOf(_stride).ptr,
			cast VarPointer.addressOf(_offset).ptr);
	}
	...
	/**
	 * Flushes the context data.
	**/
	public function flush():Void
	{
		(cast ptr : Star<NativeID3D11DeviceContext>).Flush();
	}

	public function copyResource(destinationResource:D3d11Resource, sourceResource:D3d11Resource):Void
	{
		(cast ptr : Star<NativeID3D11DeviceContext>).CopyResource((cast destinationResource.ptr : Star<NativeID3D11Resource>),
			(cast sourceResource.ptr : Star<NativeID3D11Resource>));
	}

	public function resolveSubresource(destinationResource:D3d11Resource, dstSubResource:Int, srcResource:D3d11Resource, srcSubResource:Int,
			fmt:DxgiFormat):Void
	{
		(cast ptr : Star<NativeID3D11DeviceContext>).ResolveSubresource((cast destinationResource.ptr : Star<NativeID3D11Resource>), dstSubResource,
			(cast srcResource.ptr : Star<NativeID3D11Resource>), srcSubResource, cast fmt);
	}
}
...
extern class NativeID3D11DeviceContext extends NativeIUnknown
{
	...
	@:native('ResolveSubresource')
	function ResolveSubresource(pDestResource:Star<NativeID3D11Resource>, dstSubResource:UInt32, srcResource:Star<NativeID3D11Resource>,
		srcSubResource:UInt32, format:NativeDXGIFormat):Void;

	@:native('Map')
	function map(_resource:Star<NativeID3D11Resource>, _subresource:cpp.UInt32, _mapType:NativeD3D11Map, _mapFlags:cpp.UInt32,
		_mappedSubresource:Star<NativeD3D11MappedSubResource>):Int;

	@:native('Unmap')
	function unmap(_resource:Star<NativeID3D11Resource>, _subresource:cpp.UInt32):Void;

	@:native('UpdateSubresource')
	function updateSubresource(_resource:Star<NativeID3D11Resource>, _dstSubresource:cpp.UInt32, _dstBox:Star<NativeD3D11Box>, _srcData:Star<cpp.Void>,
		_srcRowPitch:cpp.UInt32, _srcDepthPitch:cpp.UInt32):Void;
	...
	function omSetRenderTargets(_numViews:Int, _renderTargetViews:Star<Star<NativeID3D11RenderTargetView>>,
		_depthStencilView:Star<NativeID3D11DepthStencilView>):Void;
	...
	function iaSetVertexBuffers(_startSlot:cpp.UInt32, _numBuffers:cpp.UInt32, _vertexBuffers:Star<Star<NativeID3D11Buffer>>, _strides:Star<cpp.UInt32>,
		_offsets:Star<cpp.UInt32>):Void;
	...
	@:native('VSSetShader')
	function vsSetShader(_vertexShader:Star<NativeID3D11VertexShader>, _classInstances:Star<Star<NativeID3D11ClassInstance>>,
		_numClassInstances:cpp.UInt32):Void;
	...
	@:native('PSSetShader')
	function psSetShader(_vertexShader:Star<NativeID3D11PixelShader>, _classInstances:Star<Star<NativeID3D11ClassInstance>>,
		_numClassInstances:cpp.UInt32):Void;
	...
	@:native('CopyResource')
	function CopyResource(pDstResource:Star<NativeID3D11Resource>, pSrcResource:Star<NativeID3D11Resource>):Void;
}
...
class D3d11DeviceContext1 extends D3d11DeviceContext
{
	...
	public function psSetConstantBuffers1(_startSlot:Int, _buffers:Array<D3d11Buffer>, _offsets:Array<Int>, _lengths:Array<Int>)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext1>).psSetConstantBuffers1(_startSlot, _buffers.length, vectorBuffer.data(),
			cast Pointer.arrayElem(_offsets, 0).ptr, cast Pointer.arrayElem(_lengths, 0).ptr);
	}
	...
	public function psSetConstantBuffer1(_slot:Int, _buffer:D3d11Buffer, _offset:Int, _length:Int)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext1>).psSetConstantBuffers1(_slot, 1, vectorBuffer.data(), cast VarPointer.addressOf(_offset).ptr,
			cast VarPointer.addressOf(_length).ptr);
	}
	...
	public function vsSetConstantBuffers1(_startSlot:Int, _buffers:Array<D3d11Buffer>, _offsets:Array<Int>, _lengths:Array<Int>)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext1>).vsSetConstantBuffers1(_startSlot, _buffers.length, vectorBuffer.data(),
			cast Pointer.arrayElem(_offsets, 0).ptr, cast Pointer.arrayElem(_lengths, 0).ptr);
	}
	...
	public function vsSetConstantBuffer1(_slot:Int, _buffer:D3d11Buffer, _offset:Int, _length:Int)
	{
		...
		(cast ptr : Star<NativeID3D11DeviceContext1>).vsSetConstantBuffers1(_slot, 1, vectorBuffer.data(), cast VarPointer.addressOf(_offset).ptr,
			cast VarPointer.addressOf(_length).ptr);
	}
}
...
extern class NativeID3D11DeviceContext1 extends NativeID3D11DeviceContext
{
	...
	function psSetConstantBuffers1(_startSlot:cpp.UInt32, _numBuffers:cpp.UInt32, _constantBuffers:Star<Star<NativeID3D11Buffer>>,
		_firstConstants:Star<cpp.UInt32>, _numConstants:Star<cpp.UInt32>):Void;

	@:native('VSSetConstantBuffers1')
	function vsSetConstantBuffers1(_startSlot:cpp.UInt32, _numBuffers:cpp.UInt32, _constantBuffers:Star<Star<NativeID3D11Buffer>>,
		_firstConstants:Star<cpp.UInt32>, _numConstants:Star<cpp.UInt32>):Void;
}
